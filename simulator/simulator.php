...
<script try="text/javascript" src="simulator.js"></script>

<body ng-app="appSimulator" ng-controller="CtrlSimulator">

<div class="w3-panel w3-animate-opacity">
<div class="w3-tag w3-jumbo">S</div>
<div class="w3-tag w3-jumbo">I</div>
<div class="w3-tag w3-jumbo">M</div>
...
<div class="w3-third">
  <div class="w3-card" ng-init="getdata_room()" >
      <div class="w3-container w3-red">
        <h1><b>OPEN-CLASS</b></h1>
      </div>
